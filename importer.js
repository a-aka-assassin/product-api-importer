...
//Make an Additional key value pair to give date
const additionalKey = 'date';
const additionalValue = new Date().toISOString().split('T')[0];
...
const tsvData = lines.map(line => {
  ...
  //Add the date
  row[additionalKey] = additionalValue;
...
console.log('TSV file created and saved successfully.');
}
